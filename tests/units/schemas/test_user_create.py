...
def test_firstname_should_not_exceed_50_characters(valid_UserCreate):
...
def test_firstname_should_not_be_empty(valid_UserCreate):
    valid_UserCreate["first_name"] = None
    with pytest.raises(ValueError):
        _ = UserCreate(**valid_UserCreate)

    # valid_UserCreate["first_name"] = ""
    # with pytest.raises(ValueError):
    #     _ = UserCreate(**valid_UserCreate)
