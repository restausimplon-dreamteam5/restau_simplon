...
| telephone | int         |    Numero de téléphone de l'utilisateur| non nul | 0612834822
...
| prix | float       |    Prix TTC de l'article | > 0, non null, décimal (8,2)| Julien|
...
| Champ            | Type          | Description|  Contraintes|  Exemple|
| --------------- |---------------| -----| -----|-----|
| id                |    uuid     |  Identification unique (à not combinaison key possible)| PK   |  e582aa43347a4e7fa994510fdd0ad486|
| quantite | string         |    Etat de la commande | Enum : en preparation, prête et servie | en preparation|
